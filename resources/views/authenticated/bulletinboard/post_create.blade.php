  ...
  <div class="post_create_area border w-50 m-5 p-5">
    <div class="">
      ...
      <select class="w-100" form="postCreate" name="post_category_id">
        ...
        <optgroup label="{{ $main_category->main_category }}" class="groupColor"></optgroup>
        <!-- サブカテゴリー表示 -->
          <?php
          $sub_categories = \DB::table('sub_categories')->where('main_category_id',$main_category->id)->get();
          ?>
